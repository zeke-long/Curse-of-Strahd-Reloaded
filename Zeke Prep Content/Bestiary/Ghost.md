...
actions:
  ...
  - name: Horrifying Visage
    desc: Each non-undead creature within 60 ft. of the ghost that can see it must
      ...
      target's saving throw is successful or the effect ends for it, the target
      is immune to this ghost's Horrifying Visage for the next 24 hours. The
      aging effect can be reversed with a greater restoration spell, but only
...
# Random Encounter
*A baleful apparition appears before you, its hollow eyes dark with anger. The Ghost approaches and whispers in `dice: [[Random Member of the Party#^partyMemberMKE]]`'s ear "No one will ever know you died here"'*
Then attacks - if it successfully possess a character, then it hurls itself into the river. 
^RandomEncounter
